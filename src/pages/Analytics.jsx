...
const COLORS = ["#52b788", "#4a7e64", "#52b78840"];
...
export default function Analytics() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(userRef, (snap) => {
      ...
      const completed = userData.completedDeadlines || [];
      ...
      const graphData = Object.keys(dateMap)
        .sort()
        .map((date) => ({
          date,
    ...
    <>
      ...
      <div className="analytics-container">
        ...
        <div className="analytics-card">
          <h2>Completed Deadlines Per Day</h2>

          {lineData.length === 0 ? (
            <div className="empty-state">No completed deadlines</div>
          ) : (
